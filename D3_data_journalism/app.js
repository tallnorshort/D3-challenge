...
var width = parseInt(d3.select("#scatter").style("width"));  //The parseInt() function parses a string argument and 
                                                            //returns an integer of the specified radix (the base in mathematical numeral systems).
//The style property returns a CSSStyleDeclaration object, which represents an element's style attribute. The "#scatter" creates a div class we can
//call in our html 
//STEP ONE
//Creating the variables for the scatter plot graph and designing in the height/weight of the graph
...
//This function is recalled later on the code 
...
//in this case we are calling in 'class' for text style
